...
public class HomeCoffeeFilter extends Filter {

    UserCoffeeAdapter coffeeAdapter;
    ArrayList<CoffeeModel> coffeeModelList;

    public HomeCoffeeFilter(UserCoffeeAdapter coffeeAdapter, ArrayList<CoffeeModel> coffeeModelList) {
